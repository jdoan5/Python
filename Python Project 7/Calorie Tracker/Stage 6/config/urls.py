...
Including another URLconf
    1. Import the include() function: from django.http import HttpResponse
...
urlpatterns = [
    # Unauthenticated liveness probe for container healthchecks; exempted
    # from the prod SSL redirect (SECURE_REDIRECT_EXEMPT).
